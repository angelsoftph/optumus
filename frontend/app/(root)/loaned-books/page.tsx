...
import LoanedBooksComponent from "@/components/loaned";

const LoanedBooksPage: React.FC = () => {
          ...
          <div className="flex flex-col md:flex-row w-full">
            ...
            <div className="flex flex-col w-full md:w-2/3 lg:w-3/4 xl:w-4/5 gap-4">
              <div className="flex flex-col p-4 w-full">
                <h1 className="text-2xl font-semibold mb-3">Loaned Books</h1>
                <p className="text-sm mb-6">
                  List of books that are currently in your possession.
                </p>
...
export default LoanedBooksPage;
